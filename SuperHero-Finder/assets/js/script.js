...
$(document).ready(() =>{
    ...
    $('form').submit(()=> {
        ...
        //Manejo de errores
        try {
            valueInput > 0 && valueInput <= 731 ? searchId(valueInput) : searchName(valueInput)
            
            //Esperamos hasta que seleecione un Heroe
                ...
                let card = `
                        <div class="card1" style="width: 20rem;">
                            ...
                            <div class="card-body1">
                                ...
                                <a hero="${id}" href="#${id}" class="btn-superHero btn btn-outline-primary btn-block">Seleccionar</a>
                            </div>
                        </div>`
            //Almacenamos texto 
            htmlInsert += card
            ...
            let card = `
                <div class="card" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="card-text text-capitalize font-weight-bold">${data.biography.alignment} Boy &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp; Id: ${id}</h6>
                        <p class="card-text">Aliases: ${alias}</p>
                        <p class="card-text">Race: ${data.appearance.race}</p>
                        <p class="card-text">Gender: ${data.appearance.gender} -- ${data.appearance.height[1]} -- ${data.appearance.weight[1]}</p>
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="card-text text-capitalize font-weight-bold">${data.biography.alignment} Boy &emsp; Id: ${id}</p>
                                ...
                                <a href="${img}" class="btn btn-primary">View Profile</a>
                            </div>
                        </div>
                    </div>
                </div>
